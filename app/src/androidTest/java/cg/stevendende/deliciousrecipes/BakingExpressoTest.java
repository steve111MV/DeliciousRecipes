...
public class BakingExpressoTest {
    ...
    public void testRecipesRecyclerView_ingredientsRecyclerView_ingredientDetailsView() {
        ...
        onView(withId(R.id.myRecyclerView)).perform(actionOnItemAtPosition(1, click()));
    ...
    public void testRecipesRecyclerView_stepsRecyclerView_stepDetailsView() {
        ...
        onView(withId(R.id.myRecyclerView)).perform(actionOnItemAtPosition(0, click()));
        ...
        onView(withId(R.id.shortDescriptionDetails)).check(matches(withText(RECIPE_CHEESCAKE_FIRST__STEP_THIRD__SHORT_DESCRIPTION)));
