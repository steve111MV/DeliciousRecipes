...
public class RecipesDBHelper extends SQLiteOpenHelper {
    ...
    public RecipesDBHelper(Context context) {
        super(context, RecipesContract.DATABASE_NAME, null, DATABASE_VERSION);
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(Constants.SQL_CREATE_RECIPES_TABLE);
        db.execSQL(Constants.SQL_CREATE_RECIPE_STEPS_TABLE);
        db.execSQL(Constants.SQL_CREATE_RECIPE_INGREDIENTS_TABLE);
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE IF EXISTS " + RecipesContract.RecipeStepEntry.TABLE_NAME);
